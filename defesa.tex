...
%		\item Pela Proposição \ref{superficie-minima-como-ponto-critico-do-funcional-da-area}, $M$ é uma superfície mínima.
		\pause
...
\begin{frame}
	...
	\begin{definicao}
%		Dada uma superfície regular $M$ em $\R^3$, 
...
\begin{frame}
	...
	\begin{itemize}
		...
		\pause 
%		\item Pelo principio de Johann Bernoulli de trabalho virtual, 
